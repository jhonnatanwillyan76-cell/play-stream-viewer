...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BLUDVflix — Filmes e Séries Online" },
      { name: "description", content: "Assista filmes e séries com capas oficiais e player integrado." },
      { property: "og:title", content: "BLUDVflix — Filmes e Séries Online" },
