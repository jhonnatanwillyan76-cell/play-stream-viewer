    ...
    handlers: {
      GET: async () => {
        ...
        try {
          ...
          console.log("Debug: M3U Fetch Success, length:", text.length);
          ...
          console.error("Debug: M3U Fetch Error:", e);
